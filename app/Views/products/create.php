    ...
    <form action="<?= base_url('/products/store') ?>" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="text" id="code" name="code" value="<?= esc(old('code')) ?>"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
            </div>
            <div>
                <label for="plu" class="block text-sm font-medium text-gray-700 mb-2">PLU</label>
                <input type="text" id="plu" name="plu" value="<?= esc(old('plu')) ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
                ...
                <input type="text" id="unit" name="unit" value="<?= esc(old('unit')) ?>" placeholder="pcs, box, kg..."
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
            </div>
            <div>
                <label for="category" class="block text-sm font-medium text-gray-700 mb-2">Category</label>
                <input type="text" id="category" name="category" value="<?= esc(old('category')) ?>"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
                <label for="department" class="block text-sm font-medium text-gray-700 mb-2">Department</label>
                <input type="text" id="department" name="department" value="<?= esc(old('department')) ?>"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
                ...
                <input type="number" step="0.01" id="buy_price" name="buy_price" value="<?= esc(old('buy_price', 0)) ?>"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
                <label for="sell_price" class="block text-sm font-medium text-gray-700 mb-2">Sell Price</label>
                <input type="number" step="0.01" id="sell_price" name="sell_price" value="<?= esc(old('sell_price', 0)) ?>"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
                <label for="stock" class="block text-sm font-medium text-gray-700 mb-2">Initial Stock</label>
                <input type="number" step="0.01" id="stock" name="stock" value="<?= esc(old('stock', 0)) ?>"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" id="supplier" name="supplier" value="<?= esc(old('supplier')) ?>"
                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
        </div>
